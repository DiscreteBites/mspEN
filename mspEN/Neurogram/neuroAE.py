...
class NeuroEncoder(nn.Module):
    def __init__(self, image_size, nf, hidden_size=None, nc=3):
        super(NeuroEncoder, self).__init__()
...
class NeuroDecoder(nn.Module):
    ...
    def __init__(self, image_size, nf, hidden_size=None, nc=3):
        super(NeuroDecoder, self).__init__()
        self.image_size = image_size
        self.hidden_size = hidden_size
        sequens = [
            nn.Tanh(),
...
class CnnVae(nn.Module):
    def __init__(self, image_size, label_size, nf, hidden_size=None, nc=3):
        ...
        self.encoder = NeuroDecoder(image_size, nf, hidden_size)
        self.decoder = NeuroDecoder(image_size, nf, hidden_size)
        self.image_size = image_size
        self.nc = nc
