...
class ElectroEncoder(nn.Module):
    def __init__(self, image_size, nf, hidden_size=None, nc=3):
        super(ElectroEncoder, self).__init__()
...
class ElectroDecoder(nn.Module):
    ...
    def __init__(self, image_size, nf, hidden_size=None, nc=3):
        super(ElectroDecoder, self).__init__()
        self.image_size = image_size
        self.hidden_size = hidden_size
        sequens = [
            nn.Tanh(),
...
class CnnVae(nn.Module):
    def __init__(self, image_size, label_size, nf, hidden_size=None, nc=3):
        ...
        self.encoder = ElectroDecoder(image_size, nf, hidden_size)
        self.decoder = ElectroDecoder(image_size, nf, hidden_size)
        self.image_size = image_size
        self.nc = nc
